...
OLD="<!DOCTYPE html>"
NEW="<!DOCTYPE html><meta property='og:title' content='Finardry' /><meta property='og:description' content='FC時代のウィザードリィをFC時代のFF風のUIにアレンジした二次創作ゲーム。ブラウザでプレイ可能。' /><meta property='og:image' content='/ogp.jpg' /><meta name='viewport' content='width=512' /><link rel='manifest' href='/manifest.json' /><script> if ('serviceWorker' in navigator) navigator.serviceWorker.register('/sw.js')</script>"
