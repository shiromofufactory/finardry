...
OLD="<!DOCTYPE html>"
NEW="<!DOCTYPE html><meta property='og:image' content='/ogp.png' /><meta name='viewport' content='width=512' /><link rel='manifest' href='/manifest.json' /><script> if ('serviceWorker' in navigator) navigator.serviceWorker.register('/sw.js')</script>"
